...
`Note: Exclude takes presidence over include. You can include the iphone device type and then exclude lillianiphone a
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDI4NDE1MzI5LC0zMTc3MTU3NzcsODA2OT
E5MjUzXX0=
-->